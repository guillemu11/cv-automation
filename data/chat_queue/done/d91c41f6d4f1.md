# chatqueue request `d91c41f6d4f1`

- **caller**: `career_ops.analyzer`
- **kind**: `structured`
- **tier**: `sonnet`
- **created_at**: 2026-05-21T08:53:20.767215+00:00
...
**Reply**: write a single fenced ```json``` block in `outbox/d91c41f6d4f1.md` whose object matches `input_schema`.
